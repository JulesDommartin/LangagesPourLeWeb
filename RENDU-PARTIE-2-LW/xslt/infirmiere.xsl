...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
            ...
            <body>
                <div class="infirmier">
                    ...
                    <img class="photo-infirmiere">
                        <xsl:attribute name="src">../web/data/img/<xsl:value-of select="$infirmier/cab:photo"/>
                        </xsl:attribute>
                    </img>
                    <br/>
    ...
    <xsl:template match="cab:patient">
        <li class="patient">
            <div class="id-patient">
                ...
                <br/>
                <b>Soins : </b>
                <ul><xsl:apply-templates select="cab:visite/cab:acte"/></ul>
            </div>
    ...
    <xsl:template match="cab:acte">
        ...
        <li>- <xsl:value-of select="$actes/act:actes/act:acte[@id=$idActe]"/></li>
    </xsl:template>
