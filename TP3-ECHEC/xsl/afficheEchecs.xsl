            ...
            <xsl:attribute name="bgcolor">
             ...
             <xsl:choose>
                <xsl:when test="/*/ech:piece[(ech:position/ech:ligne/text()=$ligne)and(ech:position/ech:colonne/text()=$colonne)]">
                 <img border="0">
                   <xsl:attribute name="src">../web/jeu/<xsl:value-of select="/*/ech:piece[(ech:position/ech:ligne/text()=$ligne)and(ech:position/ech:colonne/text()=$colonne)]/ech:nom"/>_blanc.gif</xsl:attribute>
               ...
               <xsl:when test="/ech:echec/ech:piecesBlanches/ech:piece[(ech:position/ech:ligne/text()=$ligne)and(ech:position/ech:colonne/text()=$colonne)]">
                 <img border="0">
                   <xsl:attribute name="src">../web/jeu/<xsl:value-of select="/ech:echec/ech:piecesBlanches/ech:piece[(ech:position/ech:ligne/text()=$ligne)and(ech:position/ech:colonne/text()=$colonne)]/ech:nom"/>_blanc.gif</xsl:attribute>
               ...
               <xsl:when test="/ech:echec/ech:piecesNoires/ech:piece[(ech:position/ech:ligne/text()=$ligne)and(ech:position/ech:colonne/text()=$colonne)]">
                 <img border="0">
                   <xsl:attribute name="src">../web/jeu/<xsl:value-of select="/ech:echec/ech:piecesNoires/ech:piece[(ech:position/ech:ligne/text()=$ligne)and(ech:position/ech:colonne/text()=$colonne)]/ech:nom"/>_noir.gif</xsl:attribute>
